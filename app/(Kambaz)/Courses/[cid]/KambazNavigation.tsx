...
export default function KambazNavigation() {
  return (
    <ListGroup>
      <Link href="/Account" className="text-decoration-none">
        <ListGroupItem className="my-hover-btn border-0 text-center">
          <div className="align-kambaz-items d-flex gap-2">
            <FaRegCircleUser className="fs-2 text-danger" />
      ...
      <Link href="/Labs" className="text-decoration-none">
        <ListGroupItem className="my-hover-btn border-0 text-center">
          <div className="align-kambaz-items d-flex gap-2">
      ...
      <Link href="/Inbox" className="text-decoration-none">
        <ListGroupItem className="my-hover-btn border-0 text-center">
          <div className="align-kambaz-items d-flex gap-2">
            <FaEnvelopeOpenText className="fs-2 text-danger" />
      ...
      <Link href="/HistoryFolder" className="text-decoration-none">
        <ListGroupItem className="my-hover-btn border-0 text-center">
          <div className="align-kambaz-items d-flex gap-2">
            <FaRegClock className="fs-2 text-danger" />
            <div className="text-danger">History</div>
          </div>
        </ListGroupItem>
      </Link>

      <Link href="/Studio" className="text-decoration-none">
        <ListGroupItem className="my-hover-btn border-0 text-center">
          <div className="align-kambaz-items d-flex gap-2">
            <svg viewBox="0 0 64 64" width="24" height="24" fill="#dc3545">
            ...
            <div className="text-danger">Studio</div>
          </div>
        </ListGroupItem>
      </Link>
      ...
      <Link href="/Help" className="text-decoration-none">
        <ListGroupItem className="my-hover-btn border-0 text-center">
          <div className="align-kambaz-items d-flex gap-2">
            <RxQuestionMarkCircled className="fs-2 text-danger" />
            <div className="text-danger">Help</div>
          </div>
        </ListGroupItem>
      </Link>
    </ListGroup>
