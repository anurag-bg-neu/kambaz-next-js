...
type Assignment = {id: string, title: string, description: string, due: string, completed: boolean};

export default function WorkingWithObjectsAsynchronously() {
  const [assignment, setAssignment] = useState<Assignment>({
    id: "1", title: "", description: "", due: "", completed: false
  });
  ...
  return (
    <div id="wd-asynchronous-objects">
      ...
      <div className="form-check form-switch">
        <input className="form-check-input" type="checkbox" id="wd-completed" defaultChecked={assignment.completed}
